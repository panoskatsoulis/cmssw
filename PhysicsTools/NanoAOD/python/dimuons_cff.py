...
DiMuonTable = cms.EDProducer("SimpleCompositeCandidateFlatTableProducer",
    ...
    variables = cms.PSet(
      ...
      vtx_chi2 = Var("userFloat('chi2')",float,doc="chi2 of dimuon vtx",precision=12),
      dxyz = Var("userFloat('dxyz_SV')",float,doc="Maximum dxyz of muon trajectory w.r.t. SV",precision=12),
