...
Stage2L1HardwareValidation = cms.Sequence(
    ...
    valBmtfDigis + #EmulateLegacy
    valKBmtfStubs + #EmulateKalmanInput
    valKBmtfDigis + #EmulateKalman
    valBmtfAlgoSel + #CheckTrigAlgo
    valOmtfDigis +
    valEmtfStage2Digis +
    valGmtCaloSumDigis +
    valGmtStage2Digis +
...
l1tdeStage2Bmtf
from DQM.L1TMonitor.L1TdeStage2kBMTF_cff import * #Contains BmtfSecond
...
l1tStage2EmulatorOnlineDQM = cms.Sequence(
    l1tdeStage2Bmtf + #CompTrigAlgo
    l1tdeStage2BmtfSecond + #CompScndAlgo
    l1tdeStage2Omtf +
